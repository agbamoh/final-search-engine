...
bucket = client.bucket('final_project_bucket207978669')
...
class MultiFileReader:
    ...
    def __init__(self):
        self._open_files = {}
        self.client = storage.Client()
        self.bucket = self.client.bucket('final_project_bucket207978669')
    ...
    def read(self, locs, n_bytes):
        ...
        for f_name, offset in locs:
            if f_name not in self._open_files:
                blob = self.bucket.blob(f"postings_gcp/postings_gcp_{f_name}")
...
class InvertedIndex:
    def __init__(self, docs={}):
        ...
        self.Length_of_docs = defaultdict(int)  # dic={(doc_id):len(text)}
        self.id_to_title={}
        self.id_to_anchor={}
